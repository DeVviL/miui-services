...
.method private getOpLocked(Lcom/android/server/AppOpsService$Ops;IZ)Lcom/android/server/AppOpsService$Op;
    ...
    iget v4, p1, Lcom/android/server/AppOpsService$Ops;->uid:I
...
.method public checkOperation(IILjava/lang/String;)I
    ...
    invoke-direct {p0, v9, p2, p3, v0}, Lcom/android/server/AppOpsService;->getOpLocked(IILjava/lang/String;Z)Lcom/android/server/AppOpsService$Op;
    ...
    :cond_4
    iget v6, v7, Lcom/android/server/AppOpsService$Op;->mode:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public noteOperation(IILjava/lang/String;)I
    ...
    :try_start_0
    invoke-direct {p0, p2, p3, v1}, Lcom/android/server/AppOpsService;->getOpsLocked(ILjava/lang/String;Z)Lcom/android/server/AppOpsService$Ops;
    ...
    const-string v10, "Noting op not finished: uid "
    ...
    iget-wide v10, v6, Lcom/android/server/AppOpsService$Op;->time:J
    ...
    iget v10, v6, Lcom/android/server/AppOpsService$Op;->duration:I
    ...
    invoke-direct {p0, v7, v3, v1}, Lcom/android/server/AppOpsService;->getOpLocked(Lcom/android/server/AppOpsService$Ops;IZ)Lcom/android/server/AppOpsService$Op;
    ...
    iget v1, v6, Lcom/android/server/AppOpsService$Op;->noteOpCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, v6, Lcom/android/server/AppOpsService$Op;->noteOpCount:I

    iget-object v1, p0, Lcom/android/server/AppOpsService;->mServiceState:Lcom/android/server/AppOpsServiceState;

    invoke-virtual {v1, v3, p2, p3}, Lcom/android/server/AppOpsServiceState;->askOperationLocked(IILjava/lang/String;)I
    ...
    invoke-virtual {v1, p1, p2, p3}, Lcom/android/server/AppOpsServiceState;->isMiuiAllowed(IILjava/lang/String;)Z
    ...
    invoke-virtual {v1, p1, p2, p3}, Lcom/android/server/AppOpsServiceState;->allowedToMode(IILjava/lang/String;)I

    move-result v4

    iput v4, v8, Lcom/android/server/AppOpsService$Op;->mode:I
...
.method public publish(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/AppOpsServiceState;->init(Landroid/content/Context;)V
...
.method public startOperation(Landroid/os/IBinder;IILjava/lang/String;)I
    ...
    invoke-direct {p0, v9, p2, v0}, Lcom/android/server/AppOpsService;->getOpLocked(Lcom/android/server/AppOpsService$Ops;IZ)Lcom/android/server/AppOpsService$Op;
    ...
    invoke-direct {p0, v9, v3, v0}, Lcom/android/server/AppOpsService;->getOpLocked(Lcom/android/server/AppOpsService$Ops;IZ)Lcom/android/server/AppOpsService$Op;
    ...
    iget v4, v10, Lcom/android/server/AppOpsService$Op;->mode:I

    iget-object v0, p0, Lcom/android/server/AppOpsService;->mServiceState:Lcom/android/server/AppOpsServiceState;

    invoke-virtual {v0, p2, p3}, Lcom/android/server/AppOpsServiceState;->isAppPermissionControlOpen(II)Z
    ...
    iget v0, v8, Lcom/android/server/AppOpsService$Op;->startOpCount:I

    add-int/lit8 v0, v0, 0x1

    iput v0, v8, Lcom/android/server/AppOpsService$Op;->startOpCount:I

    iget-object v7, v6, Lcom/android/server/AppOpsService$ClientState;->mAppToken:Landroid/os/IBinder;

    iget-object v0, v8, Lcom/android/server/AppOpsService$Op;->clientTokens:Ljava/util/ArrayList;

    invoke-virtual {v0, v7}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, p0, Lcom/android/server/AppOpsService;->mServiceState:Lcom/android/server/AppOpsServiceState;

    invoke-virtual {v0, v3, p3, p4}, Lcom/android/server/AppOpsServiceState;->askOperationLocked(IILjava/lang/String;)I
    ...
    invoke-virtual {v0, p2, p3, p4}, Lcom/android/server/AppOpsServiceState;->isMiuiAllowed(IILjava/lang/String;)Z
    ...
    iget v0, v8, Lcom/android/server/AppOpsService$Op;->nesting:I
    ...
    iput v0, v8, Lcom/android/server/AppOpsService$Op;->nesting:I
...
.method public systemReady()V
    ...
    iget-object v7, p0, Lcom/android/server/AppOpsService;->mServiceState:Lcom/android/server/AppOpsServiceState;

    invoke-virtual {v7}, Lcom/android/server/AppOpsServiceState;->systemReady()V
