...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/BluetoothManagerService$CsmClientBt;
    }
.end annotation
...
.field private mCsmClient:Lcom/android/server/BluetoothManagerService$CsmClientBt;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 256
    new-instance v3, Lcom/android/server/BluetoothManagerService$3;

    new-instance v4, Landroid/os/Handler;

    invoke-direct {v4}, Landroid/os/Handler;-><init>()V

    invoke-direct {v3, p0, v4}, Lcom/android/server/BluetoothManagerService$3;-><init>(Lcom/android/server/BluetoothManagerService;Landroid/os/Handler;)V

    iput-object v3, p0, Lcom/android/server/BluetoothManagerService;->mObserver:Landroid/database/ContentObserver;
    ...
    const-string v4, "bluetooth_hci_log"

    invoke-static {v4}, Landroid/provider/Settings$Secure;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v4

    iget-object v5, p0, Lcom/android/server/BluetoothManagerService;->mObserver:Landroid/database/ContentObserver;
    ...
    const-string v4, "bluetooth_trace_log"
    ...
    .line 315
    iput-boolean v7, p0, Lcom/android/server/BluetoothManagerService;->mEnableExternal:Z

    .line 319
    :cond_0
    :try_start_0
    new-instance v3, Lcom/android/server/BluetoothManagerService$CsmClientBt;

    iget-object v4, p0, Lcom/android/server/BluetoothManagerService;->mContext:Landroid/content/Context;

    invoke-direct {v3, p0, v4}, Lcom/android/server/BluetoothManagerService$CsmClientBt;-><init>(Lcom/android/server/BluetoothManagerService;Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/server/BluetoothManagerService;->mCsmClient:Lcom/android/server/BluetoothManagerService$CsmClientBt;
    :try_end_0
    ...
    const-string v4, "Unable to create CsmClientBt."
...
.method static synthetic access$000(Lcom/android/server/BluetoothManagerService;)Z
    .locals 1
...
.method static synthetic access$002(Lcom/android/server/BluetoothManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$100(Lcom/android/server/BluetoothManagerService;)Lcom/android/server/BluetoothManagerService$BluetoothHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$1400(Lcom/android/server/BluetoothManagerService;)Landroid/content/ContentResolver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$2100(Lcom/android/server/BluetoothManagerService;ZZ)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method static synthetic access$4000(Lcom/android/server/BluetoothManagerService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method private bluetoothStateChangeHandler(II)V
    ...
    const-string v6, "android.bluetooth.adapter.action.RADIO_STATE_CHANGED"

    invoke-direct {v4, v6}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1553
    .local v4, "intentRadio1":Landroid/content/Intent;
    ...
    .line 1619
    .end local v4    # "intentRadio1":Landroid/content/Intent;
    :cond_0
    :goto_0
    return-void
    ...
    .line 1569
    iget-object v6, p0, Lcom/android/server/BluetoothManagerService;->mCsmClient:Lcom/android/server/BluetoothManagerService$CsmClientBt;
    ...
    invoke-virtual {v6}, Lcom/android/server/BluetoothManagerService$CsmClientBt;->csmStartModem()Z
    :try_end_0
    .catch Lcom/intel/cws/cwsservicemanager/CsmException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v7, "Unable to start CsmClientBt."
    ...
    invoke-virtual {v6}, Lcom/android/server/BluetoothManagerService$CsmClientBt;->csmStop()V
    ...
    .line 1612
    .local v3, "intentRadio":Landroid/content/Intent;
    const-string v6, "android.bluetooth.adapter.extra.PREVIOUS_STATE"
...
.method private handleEnableRadio()V
    ...
    invoke-virtual {v1, v3, v5}, Landroid/content/Intent;->resolveSystemService(Landroid/content/pm/PackageManager;I)Landroid/content/ComponentName;
...
.method public bindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)Z
    ...
    .line 680
    .restart local v2    # "psc":Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;
    invoke-static {v2}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$1500(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;)Z
...
.method public unbindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)V
    ...
    .line 702
    :cond_0
    invoke-static {v0, p2}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$1600(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;Landroid/bluetooth/IBluetoothProfileServiceConnection;)V
