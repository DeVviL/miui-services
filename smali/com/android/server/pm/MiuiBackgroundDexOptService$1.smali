.class Lcom/android/server/pm/MiuiBackgroundDexOptService$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/server/pm/MiuiBackgroundDexOptService;->onStartJob(Landroid/app/job/JobParameters;)Z
.end annotation
...
# instance fields
.field final synthetic this$0:Lcom/android/server/pm/MiuiBackgroundDexOptService;

.field final synthetic val$jobParams:Landroid/app/job/JobParameters;

.field final synthetic val$mostPkgs:Landroid/util/ArraySet;
...
.method constructor <init>(Lcom/android/server/pm/MiuiBackgroundDexOptService;Ljava/lang/String;Landroid/util/ArraySet;Lcom/android/server/pm/PackageManagerService;Landroid/app/job/JobParameters;)V
    ...
    iput-object p4, p0, Lcom/android/server/pm/MiuiBackgroundDexOptService$1;->val$pm:Lcom/android/server/pm/PackageManagerService;

    iput-object p5, p0, Lcom/android/server/pm/MiuiBackgroundDexOptService$1;->val$jobParams:Landroid/app/job/JobParameters;
...
.method public run()V
    ...
    iget-object v3, p0, Lcom/android/server/pm/MiuiBackgroundDexOptService$1;->val$jobParams:Landroid/app/job/JobParameters;

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4}, Lcom/android/server/pm/MiuiBackgroundDexOptService;->jobFinished(Landroid/app/job/JobParameters;Z)V
