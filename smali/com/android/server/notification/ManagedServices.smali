...
.method private registerService(Landroid/content/ComponentName;I)V
    ...
    iget-object v0, v0, Lcom/android/server/notification/ManagedServices$Config;->settingsAction:Ljava/lang/String;
    ...
    invoke-static {v12, v14, v15, v0}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v12, v8, v0}, Lcom/android/server/notification/ManagedServicesInjector;->canBindService(Landroid/content/Context;Landroid/content/Intent;I)Z

    move-result v4

    .line 392
    .local v4, "canBindService":Z
    if-nez v4, :cond_6
    ...
    const-string v15, "AutStart Unable to bind "
    ...
    .line 399
    .restart local v4    # "canBindService":Z
    ...
    invoke-virtual {v12, v8, v14, v15, v0}, Landroid/content/Context;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
